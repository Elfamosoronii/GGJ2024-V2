...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneAkTrack_Statics::NewProp_bIsAMasterTrack = { "bIsAMasterTrack", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UMovieSceneAkTrack), &Z_Construct_UClass_UMovieSceneAkTrack_Statics::NewProp_bIsAMasterTrack_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneAkTrack_Statics::NewProp_bIsAMasterTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneAkTrack_Statics::NewProp_bIsAMasterTrack_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_AkAudio_Classes_MovieSceneAkTrack_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_AkAudio_Classes_MovieSceneAkTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneAkTrack, UMovieSceneAkTrack::StaticClass, TEXT("UMovieSceneAkTrack"), &Z_Registration_Info_UClass_UMovieSceneAkTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneAkTrack), 4135840290U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_AkAudio_Classes_MovieSceneAkTrack_h_1482875653(TEXT("/Script/AkAudio"),
		Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_AkAudio_Classes_MovieSceneAkTrack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_AkAudio_Classes_MovieSceneAkTrack_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
