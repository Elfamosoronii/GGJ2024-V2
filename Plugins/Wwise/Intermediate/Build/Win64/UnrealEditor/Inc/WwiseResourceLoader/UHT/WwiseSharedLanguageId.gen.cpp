...
template<> WWISERESOURCELOADER_API UScriptStruct* StaticStruct<FWwiseSharedLanguageId>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FWwiseSharedLanguageId_Statics::NewProp_LanguageRequirement = { "LanguageRequirement", nullptr, (EPropertyFlags)0x0010000000020815, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FWwiseSharedLanguageId, LanguageRequirement), Z_Construct_UEnum_WwiseFileHandler_EWwiseLanguageRequirement, METADATA_PARAMS(Z_Construct_UScriptStruct_FWwiseSharedLanguageId_Statics::NewProp_LanguageRequirement_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWwiseSharedLanguageId_Statics::NewProp_LanguageRequirement_MetaData)) }; // 3988255743
	...
	struct Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseSharedLanguageId_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseSharedLanguageId_h_Statics::ScriptStructInfo[] = {
		{ FWwiseSharedLanguageId::StaticStruct, Z_Construct_UScriptStruct_FWwiseSharedLanguageId_Statics::NewStructOps, TEXT("WwiseSharedLanguageId"), &Z_Registration_Info_UScriptStruct_WwiseSharedLanguageId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWwiseSharedLanguageId), 1817094082U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseSharedLanguageId_h_1591276835(TEXT("/Script/WwiseResourceLoader"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseSharedLanguageId_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_lenaig_bourlier_Documents_GitHub_GGJ2024_V2_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseSharedLanguageId_h_Statics::ScriptStructInfo),
		nullptr, 0);
